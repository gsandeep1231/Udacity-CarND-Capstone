...
from include.model.TSCNet import TSCNet
...
class TLClassifier(object):
    def __init__(self):
        ...
        with self.graph.as_default():
            self.model = TSCNet(len(self.classes), (None, None, 3), 1.0, 0)
    ...
    def get_prediction(self, images):
        ...
        with self.graph.as_default():
            ...
            #rospy.loginfo("TL Predicted: " + self.classes[pred_idx] + ", in " + str(np.sum(times)) + "ms")
